...
\begin{frame}{Empirical Strategy: Heat}
	\begin{itemize}
		\item A binary treatment indicator is not well-suited to measure cumulative heat exposure. Following \cite{Park_2020}, I use two measures:
		\begin{itemize}
...
\begin{frame}{Heat Results}
	\begin{itemize}
		...
		\item Possibly driven by unequal access to air-conditiong \citep{Park_2020}
	\end{itemize}
	\tiny
	\begin{table}
