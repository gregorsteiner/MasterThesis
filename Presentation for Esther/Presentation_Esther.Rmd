...
* [Current Population Survey (CPS)](https://www.census.gov/data/datasets/time-series/demo/cps/cps-basic.html):
  + Available monthly (refers to the week containing the 12th day of the month)
  + Includes state and county information, but county is often missing due to confidentiality laws
...
* One such provider is [Homebase](https://joinhomebase.com/), they provide daily data on hours worked or the number of employees working.
