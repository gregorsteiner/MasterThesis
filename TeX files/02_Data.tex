...
Figure \ref{AssistCovDensity} provides kernel density estimates for median income and democratic voter shares by whether a county applied for federal assistance. It seems that the median income of counties that applied is slightly lower than of those that did not apply.

\begin{figure}[!h]
	\centering
	\includegraphics[scale=0.7]{"../Code & Data/AssistanceCovDensity.png"}
	\caption{Kernel density estimates for Median Income and Democratic voter share by application status of counties}
