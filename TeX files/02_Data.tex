...
The National Weather Service (NWS) provides data on storm events. In particular, this covers hurricanes, mainly affecting southern coastal regions, and tornadoes, mainly affecting the midwest. Hurricanes and Tornadoes combined account for more than 40\% of all federal disaster assistance in the FEMA Public Assistance Applicants Program Deliveries.

Figure \ref{StormMap} shows storm exposure by county across the US. 
