...
A naive estimate of the average treatment effect using the estimator $\widehat{\tau} = \bar{Y_1} - \bar{Y_0}$ yields 
...
knitr::kable(sapply(c("EHE.MAX", "EHE.MIN"), function(x){
  ...
  return(tau.hat)
}) |> setNames(c("MaximumTemperature", "MinimumTemperature")), col.names = latex2exp::TeX("$\\widehat{\\tau}$"))
