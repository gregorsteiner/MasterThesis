...
Below you can see the average (across all counties) number of heat days based on minimum and maximum temperatures for each year.
...
invisible(within(EHEs.yearly, {
  plot(YEAR, AVG.EHE.MAX, type = "n",
       xlab = "", ylab = "Average number of extreme heat days")
  grid()
